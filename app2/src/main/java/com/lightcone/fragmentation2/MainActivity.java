...
public class MainActivity extends Activity implements List_Fragment.OnItemSelectedListener {
	...
	// This callback is required because we are implementing List_Fragment.OnItemSelectedListener.
		...
		case R.id.button04:
			...
			if (fragment != null && fragment.isInLayout()) {
				...
				if(fragAdded){
					...
					ft = fm.beginTransaction();
					ft.remove(adder);
					// Example: replace the fragment adder with the fragment myFragment
